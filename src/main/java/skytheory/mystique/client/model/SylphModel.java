...
public class SylphModel extends AbstractElementalModel<Sylph> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		head.addOrReplaceChild("hair", CubeListBuilder.create().texOffs(12, 37).addBox(1.3F, -7.0F, -4.5F, 3.0F, 6.0F, 3.0F, new CubeDeformation(-0.7F))
				.texOffs(0, 36).addBox(-5.0F, -6.5F, -0.8F, 3.0F, 7.0F, 3.0F, new CubeDeformation(-0.4F))
				.texOffs(21, 33).addBox(-1.5F, -5.0F, 3.0F, 3.0F, 6.0F, 1.0F, new CubeDeformation(0.0F))
		...
		scapula.addOrReplaceChild("armLeft", CubeListBuilder.create().texOffs(40, 0).addBox(-0.1F, -1.0F, -1.0F, 2.0F, 9.0F, 2.0F, new CubeDeformation(-0.2F))
				.texOffs(28, 56).mirror().addBox(-0.1F, 1.0F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(-0.1F)).mirror(false), PartPose.offsetAndRotation(3.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.1745F));
		...
		scapula.addOrReplaceChild("armRight", CubeListBuilder.create().texOffs(32, 0).addBox(-1.9F, -1.0F, -1.0F, 2.0F, 9.0F, 2.0F, new CubeDeformation(-0.2F))
				.texOffs(28, 56).addBox(-1.9F, 1.0F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(-3.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.1745F));
		...
		torso.addOrReplaceChild("cloth", CubeListBuilder.create().texOffs(44, 7).addBox(-3.0F, 0.0F, -2.0F, 6.0F, 9.0F, 4.0F, new CubeDeformation(0.05F))
				...
				.texOffs(22, 40).addBox(-4.0F, 7.5F, -3.0F, 8.0F, 4.0F, 6.0F, new CubeDeformation(-0.8F)), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition rootLeft = wingLeft.addOrReplaceChild("rootLeft", CubeListBuilder.create().texOffs(52, 41).mirror().addBox(-1.4F, -0.4F, -0.4F, 4.0F, 11.0F, 1.0F, new CubeDeformation(-0.4F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.3927F));

		PartDefinition middleLeft = rootLeft.addOrReplaceChild("middleLeft", CubeListBuilder.create().texOffs(37, 56).mirror().addBox(-0.4F, -6.6F, -0.4F, 3.0F, 7.0F, 1.0F, new CubeDeformation(-0.4F)).mirror(false), PartPose.offset(2.2F, 4.7F, 0.2F));

		middleLeft.addOrReplaceChild("tipLeft", CubeListBuilder.create().texOffs(36, 50).mirror().addBox(-0.4F, -4.6F, -0.4F, 6.0F, 5.0F, 1.0F, new CubeDeformation(-0.4F)).mirror(false), PartPose.offset(2.2F, -3.0F, 0.2F));
		...
		PartDefinition rootRight = wingRight.addOrReplaceChild("rootRight", CubeListBuilder.create().texOffs(52, 41).addBox(-2.6F, -0.4F, -0.4F, 4.0F, 11.0F, 1.0F, new CubeDeformation(-0.4F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.3927F));

		PartDefinition middleRight = rootRight.addOrReplaceChild("middleRight", CubeListBuilder.create().texOffs(37, 56).addBox(-2.6F, -6.6F, -0.4F, 3.0F, 7.0F, 1.0F, new CubeDeformation(-0.4F)), PartPose.offset(-2.2F, 4.7F, 0.2F));

		middleRight.addOrReplaceChild("tipRight", CubeListBuilder.create().texOffs(36, 50).addBox(-5.6F, -4.6F, -0.4F, 6.0F, 5.0F, 1.0F, new CubeDeformation(-0.4F)), PartPose.offset(-2.2F, -3.0F, 0.2F));
		...
		PartDefinition legLeft = pelvis.addOrReplaceChild("legLeft", CubeListBuilder.create().texOffs(12, 16).addBox(-1.0F, -1.1F, -1.5F, 3.0F, 7.0F, 3.0F, new CubeDeformation(-0.1F))
				...
				.texOffs(41, 34).mirror().addBox(-1.0F, 5.05F, -2.5F, 3.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(29, 35).mirror().addBox(-1.0F, 3.1F, -1.5F, 3.0F, 2.0F, 3.0F, new CubeDeformation(-0.05F)).mirror(false), PartPose.offset(1.0F, 0.0F, 0.0F));
		...
		PartDefinition legRight = pelvis.addOrReplaceChild("legRight", CubeListBuilder.create().texOffs(0, 16).addBox(-2.0F, -1.1F, -1.5F, 3.0F, 7.0F, 3.0F, new CubeDeformation(-0.1F))
				...
				.texOffs(41, 34).addBox(-2.0F, 5.05F, -2.5F, 3.0F, 2.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(29, 35).addBox(-2.0F, 3.1F, -1.5F, 3.0F, 2.0F, 3.0F, new CubeDeformation(-0.05F)), PartPose.offset(-1.0F, 0.0F, 0.0F));
