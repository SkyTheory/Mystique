...
public class UndineModel extends AbstractElementalModel<Undine> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		sleeveLeft.addOrReplaceChild("sleeveLeft_r1", CubeListBuilder.create().texOffs(56, 0).addBox(3.5F, -14.5F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.0F, 14.5F, 0.0F, 0.0F, 0.0F, -0.0436F));
		...
		sleeveRight.addOrReplaceChild("sleeveRight_r1", CubeListBuilder.create().texOffs(56, 0).mirror().addBox(-5.5F, -14.5F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(3.0F, 14.5F, 0.0F, 0.0F, 0.0F, 0.0436F));
		...
		partdefinition.addOrReplaceChild("bb_main", CubeListBuilder.create().texOffs(0, 42).addBox(-1.0F, -18.0F, 3.0F, 2.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
